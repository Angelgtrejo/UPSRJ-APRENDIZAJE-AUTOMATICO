...
## **Introducción**
Este repositorio contiene los ejercicios y prácticas de la materia **Aprendizaje Automático**. Aquí aprenderás los fundamentos del aprendizaje automático y conocerás las herramientas más populares de ciencia de datos.
...
1. Ve al repositorio público:  
   👉 [https://github.com/chucholoport/UPSRJ-APRENDIZAJE-AUTOMATICO](https://github.com/chucholoport/UPSRJ-APRENDIZAJE-AUTOMATICO)
...
```bash
git clone https://github.com/your-username/UPSRJ-APRENDIZAJE-AUTOMATICO.git
cd UPSRJ-APRENDIZAJE-AUTOMATICO
```
