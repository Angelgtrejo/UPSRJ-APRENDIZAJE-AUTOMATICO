...
#   mientras que np.arange genera una secuencia de números con un rango específico (similar a range() de Python)

# - ¿Por qué es útil la matriz identidad en álgebra lineal?
#   La matriz identidad actúa como el "1" de las matrices - cuando multiplicas cualquier matriz por la identidad
#   obtienes la matriz original. Es fundamental para resolver sistemas de ecuaciones y transformaciones lineales.
